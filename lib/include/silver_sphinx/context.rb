class SilverSphinx::Context
  ...
  def prepare
    SilverSphinx::Configuration.instance.indexed_models.each do |model|
  ...
  #
  def load_models
    SilverSphinx::Configuration.instance.model_directories.each do |base|
