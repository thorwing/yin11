  ...
  describe "routing" do
    ...
    it "recognizes and generates #update" do
     ...
     it "recognizes and generates #join" do
      { :put => "/groups/1/join" }.should route_to(:controller => "groups", :action => "join", :id => "1")
     end

    it "recognizes and generates #quit" do
      { :put => "/groups/1/quit" }.should route_to(:controller => "groups", :action => "quit", :id => "1")
    end
