  ...
  describe "POST create" do
    describe "with valid params" do
      it "assigns a newly created review as @review" do
        Review.stub(:new).with({'these' => 'params'}) { mock_review(:save => true) }
        post :create, :review => {'these' => 'params'}
        assigns(:review).should be(mock_review)
      end

      it "redirects to the created review" do
        Review.stub(:new) { mock_review(:save => true) }
        post :create, :review => {}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved review as @review" do
        Review.stub(:new).with({'these' => 'params'}) { mock_review(:save => false) }
        post :create, :review => {'these' => 'params'}
        assigns(:review).should be(mock_review)
      end

      it "re-renders the 'new' template" do
        Review.stub(:new) { mock_review(:save => false) }
        post :create, :review => {}
